...
ADMIN_UID = "15127479756"  # Your admin UID
server2 = "ME"
key2 = "MAHFUJ"
                        ...
                        if inPuTMsG.startswith('/join'):
                            ...
                            if len(parts) < 2:
                                ...
                                try:
                                    ...
                                    if can_send_emote_to(sender_uid) and can_send_emote_to(15127479756):
...
async def MaiiiinE():
    Uid, Pw = '4653777044', '67E68FF87E781EBABFACCA4796DAC9BB1CAB78C8C78A69CB85EF1D427F68C418'
